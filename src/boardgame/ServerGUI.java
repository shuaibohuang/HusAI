...
implements BoardPanel.BoardPanelListener  {
    ...
    protected static final String[] BOARD_CLASSES = {"hus.HusBoard"};
    /** The list of players that can be launched */
    protected static final String[] PLAYER_CLASSES = {"hus.RandomHusPlayer", "student_player.StudentPlayer", "student_player.oldAgent"};
